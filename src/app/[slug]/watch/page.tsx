...
import Player from "@/component/utils/player/Player";
...
export default async function Page({
  ...
  const [movie, streamLink] = await Promise.all([
    MovieService.getDetail(slug),
  ...
  const currentEpisode = movie.episodes?.find((item: any) => item.slug === ep);
